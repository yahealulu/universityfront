...
export type SecretariesPaginationProps = {
  page: number
  totalPages: number
  onPageChange: (p: number) => void
}

export const SecretariesPagination: FC<SecretariesPaginationProps> = ({
  page,
  totalPages,
  onPageChange,
}) => {
  ...
  return (
    <div className="mt-6 flex flex-wrap items-center justify-center gap-2">
      ...
      >
        ...
        {t('secretaries.pagination.previous')}
      </Button>
      {pages.map((p, i) =>
        p === 'ellipsis' ? (
