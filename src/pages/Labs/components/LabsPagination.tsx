...
export type LabsPaginationProps = {
  page: number
  totalPages: number
  onPageChange: (p: number) => void
}

export const LabsPagination: FC<LabsPaginationProps> = ({ page, totalPages, onPageChange }) => {
